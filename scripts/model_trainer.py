...
class ModelTrainer:
    ...
    def predict_from_image(image_path):
      ...
      hist = ModelTrainer.extract_histogram(img)
...
def main():
    ...
    _, face_acc, face_f1, face_loss = trainer.train_facial_recognition_model(image_features)
    _, voice_acc, voice_f1, voice_loss = trainer.train_voice_verification_model(audio_features)
    _, product_acc, product_f1, product_loss = trainer.train_product_recommendation_model(product_df)
